...
public interface DocumentTransferRepository extends JpaRepository<DocumentTransfer, Integer> {
    ...
    Page<DocumentTransfer> findByReceiverOrganization_Id(Integer orgId, Pageable pageable); 
    Page<DocumentTransfer> findByStatusAndReceiverOrganization_Id(DocumentTransfer.Status status, Integer orgId, Pageable pageable);
}
