...
public class InterconnectedSystemServiceImpl implements InterconnectedSystemService {
    ...
    public List<InterconnectedSystemResponse> findAll() {
        ...
        List<InterconnectedSystemResponse> interconnectedSystemResponses = interconnectedSystems.stream()
                .map(is -> entityToResponse(is)).toList();
        System.out.println("In request ");
        return interconnectedSystemResponses;
    }

    @Override
    public InterconnectedSystemResponse createNew(NewInterconnectedSystemRequest request) {
    ...
    @Override
    public InterconnectedSystemResponse update(Integer id, UpdateInterconnectedSystemRequest request) {
